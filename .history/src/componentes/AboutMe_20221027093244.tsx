			...
			<VStack w={"full"}>
				...
				<VStack w={"full"} bg={"black"}>
					...
					<SimpleGrid w={"90%"} py={10} columns={[1, null, 3]} spacing='40px'>
						...
						<Box bg='gray.900' borderRadius={4} p={4}>
							<Image borderRadius={4} src={"https://t2.tudocdn.net/615108?w=1920"} />
							<br />
							<VStack spacing={5}>
								<Text className={"escrevendo"} style={{ fontSize: "18px", fontFamily: "Poppins", lineHeight: "14px", letterSpacing: "0.02em" }} color={"white"}>Grand theft auto V</Text>
								<Text className={"escrevendo"} style={{ fontSize: "18px", fontFamily: "Poppins", lineHeight: "12px", letterSpacing: "0.02em" }} color={"gray.300"}>Leitura de histórias de terror</Text>
						...
						<Box bg='gray.900' borderRadius={4} p={4}>
							<Image borderRadius={4} src={"https://assets.reedpopcdn.com/heres-the-first-trailer-for-ubisofts-avatar-game-which-is-out-next-year-1623530358052.jpg/BROK/thumbnail/1600x900/format/jpg/quality/80/heres-the-first-trailer-for-ubisofts-avatar-game-which-is-out-next-year-1623530358052.jpg"} />
							<br />
							<VStack spacing={5}>
